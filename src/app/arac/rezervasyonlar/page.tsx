    ...
    <div className="p-6">
      <div className="mb-6">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-2xl font-bold text-gray-900">Araç Rezervasyonları</h1>
          <Link
            href="/arac/rezervasyonlar/yeni"
              ...
              {bookings.map((booking) => (
                <tr key={booking.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <Link
                      href={`/arac/rezervasyonlar/${booking.id}`}
                      className="text-blue-600 hover:text-blue-900 mr-3"
                    >
                      Detay
                    </Link>
                    <Link
                      href={`/arac/rezervasyonlar/${booking.id}/duzenle`}
          ...
          <div className="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
            <div className="flex items-center justify-between">
              <div className="text-sm text-gray-700">
                Toplam {totalCount} rezervasyon, sayfa {page} / {Math.ceil(totalCount / limit)}
              </div>
